...
const parts = `
  ...
  <section class="part">
    ...
    <p class="lead">모뎀칩은 아이폰이 기지국과 무선으로 통화·데이터를 주고받게 해주는 통신 전용 반도체다. 화면·연산을 담당하는 AP와 달리, "밖과 연결되는 입과 귀" 역할만 전담한다. 애플은 AP는 2010년부터 직접 설계해왔지만, 모뎀칩만큼은 오랫동안 퀄컴 제품에 의존했다 — 한때 애플 한 곳에서 나오는 매출이 퀄컴 전체 휴대폰 매출의 약 20%에 달할 정도로 비중이 컸다.</p>
    ...
    <div class="callout" style="margin-top:16px;">출처: <a href="https://zdnet.co.kr/view/?no=20260703091105">ZDNet코리아(2026.07.03)</a> · <a href="https://zdnet.co.kr/view/?no=20250301063853">ZDNet코리아(2025.03.01)</a></div>
  </section>
